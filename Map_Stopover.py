...
#Specifying color limit for land cover classes
classColo = colors.ListedColormap(['lightblue','yellow','darkorange','green','red','gray','gold','firebrick','purple','seagreen',
'magenta','maroon','palegreen','olive','darkcyan','cyan','slategray','rosybrown','sandybrown','blue'])
...
lCC_1  = mpatches.Patch(color='lightblue', label='Broadleaf Evergreen Forest')
lCC_2  = mpatches.Patch(color='yellow', label='Broadleaf Deciduous Forest')
lCC_3  = mpatches.Patch(color='darkorange', label='Needleleaf Evergreen Forest')
...
lCC_8 = mpatches.Patch(color='firebrick', label='Herbaceous')
lCC_9  = mpatches.Patch(color='purple', label='Tree/Shrub')
lCC_10  = mpatches.Patch(color='seagreen', label='Sparse vegetation')
lCC_11 = mpatches.Patch(color='magenta', label='Cropland')
lCC_12 = mpatches.Patch(color='maroon', label='Paddy field')
lCC_13 = mpatches.Patch(color='palegreen', label='Cropland/Other Vegetation Mosaic')
lCC_14 = mpatches.Patch(color='olive', label='Mangrove')
lCC_15 = mpatches.Patch(color='darkcyan', label='Wetland')
